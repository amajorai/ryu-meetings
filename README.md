<p align="center">
  <picture>
    ...
    <img src="./icon-light.png" alt="Meetings" width="144" />
  </picture>
</p>
...
Record a call, transcribe it live, and generate structured AI notes (Granola/Notion-AI style). (Python diarization sidecar held back, not yet public.)
...
**App:** [Install](ryu://apps/@ryu/meetings) (opens the Ryu desktop app and asks you to confirm)

**CLI:**

```bash
ryu apps add @ryu/meetings
```

**Crate:**

```bash
cargo install ryu-meetings
```
